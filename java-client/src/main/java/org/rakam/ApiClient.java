...
import org.rakam.auth.Authentication;
import org.rakam.auth.HttpBasicAuth;
import org.rakam.auth.ApiKeyAuth;
import org.rakam.auth.OAuth;
...
public class ApiClient {
  ...
  private String basePath = "https://app.getrakam.com/";
  ...
  public ApiClient() {
    ...
    authentications.put("read_key", new ApiKeyAuth("header", "read_key"));
    authentications.put("master_key", new ApiKeyAuth("header", "master_key"));
    authentications.put("write_key", new ApiKeyAuth("header", "write_key"));
