...
class Sorting(object):
    ...
    def column(self):
        """
        Gets the column of this Sorting.


        :return: The column of this Sorting.
        :rtype: str
        """
        return self._column
    ...
    def column(self, column):
        """
        Sets the column of this Sorting.


        :param column: The column of this Sorting.
        :type: str
        """
        self._column = column
    ...
    def order(self, order):
        ...
        if order not in allowed_values:
            raise ValueError(
                "Invalid value for `order`, must be one of {0}"
