...
namespace Rakam.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public class UserMailboxActionBatchSendMessages :  IEquatable<UserMailboxActionBatchSendMessages>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserMailboxActionBatchSendMessages" /> class.
        /// </summary>
        public UserMailboxActionBatchSendMessages()
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as UserMailboxActionBatchSendMessages);
        }

        /// <summary>
        /// Returns true if UserMailboxActionBatchSendMessages instances are equal
        /// </summary>
        /// <param name="obj">Instance of UserMailboxActionBatchSendMessages to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserMailboxActionBatchSendMessages other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
