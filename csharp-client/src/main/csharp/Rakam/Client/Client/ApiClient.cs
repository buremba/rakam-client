...
namespace Rakam.Client.Client
{
    ...
    public class ApiClient
    {
        ...
        public ApiClient(String basePath="https://app.getrakam.com/")
        {
            BasePath = basePath;
        ...
        public void UpdateParamsForAuth(Dictionary<String, String> queryParams, Dictionary<String, String> headerParams, string[] authSettings)
        {
            ...
            foreach (string auth in authSettings)
            {
                ...
                switch(auth)
                {
                    ...
                    case "read_key":
                        headerParams["read_key"] = GetApiKeyWithPrefix("read_key");
                        
                        break;
                    
                    case "master_key":
                        headerParams["master_key"] = GetApiKeyWithPrefix("master_key");
                        
                        break;
                    
                    case "write_key":
                        headerParams["write_key"] = GetApiKeyWithPrefix("write_key");
