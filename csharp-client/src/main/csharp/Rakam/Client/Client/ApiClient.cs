...
namespace Rakam.Client.Client
{
    ...
    public class ApiClient
    {
        ...
        /// with default configuration and base path (https://api.rakam.io/).
        /// </summary>
        public ApiClient()
        {
            Configuration = Configuration.Default;
            RestClient = new RestClient("https://api.rakam.io/");
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (https://api.rakam.io/).
        /// </summary>
        ...
        public ApiClient(String basePath = "https://api.rakam.io/")
        {
