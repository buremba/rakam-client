...
use \ArrayAccess;
/**
 * UserMailboxActionBatchSendMessages Class Doc Comment
 *
 * @category    Class
 * @description 
 * @package     Rakam
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class UserMailboxActionBatchSendMessages implements ArrayAccess
{
    /**
    ...
    static $swaggerTypes = array(
        ...
        'config' => '\client.model\MailAction'
    );
    ...
    /**
     * Gets config
     * @return \client.model\MailAction
     */
    ...
    /**
     * Sets config
     * @param \client.model\MailAction $config 
     * @return $this
     */
