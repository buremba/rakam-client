...
class ContinuousqueryApi
{
     ...
     */
    public function create($continuous_query)
    {
        
        // verify the required parameter 'continuous_query' is set
        if ($continuous_query === null) {
            throw new \InvalidArgumentException('Missing the required parameter $continuous_query when calling create');
        }
     ...
     * @throws \Rakam\ApiException on non-2xx response
     */
    public function listQueries($project=null)
    {
        ...
        try
        {
            ...
            return $this->apiClient->getSerializer()->deserialize($response, '\client.model\ContinuousQuery[]', $httpHeader);
     ...
     * @throws \Rakam\ApiException on non-2xx response
     */
    public function test($project=null, $query=null)
    {
        ...
        try
        {
            ...
            return $this->apiClient->getSerializer()->deserialize($response, '\client.model\SchemaField[]', $httpHeader);
