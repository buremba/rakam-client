...
class RetentionApi
{
     ...
     */
    public function retentionAnalyzerExecute($retention_query)
    {
        list($response, $statusCode, $httpHeader) = $this->retentionAnalyzerExecuteWithHttpInfo ($retention_query);
        return $response; 
    }


    /**
     * retentionAnalyzerExecuteWithHttpInfo
     *
     * Execute query
     *
     * @param \client.model\RetentionQuery $retention_query  (required)
     ...
     * @throws \Rakam\ApiException on non-2xx response
     */
    public function retentionAnalyzerExecuteWithHttpInfo($retention_query)
    {
        
        // verify the required parameter 'retention_query' is set
        if ($retention_query === null) {
            throw new \InvalidArgumentException('Missing the required parameter $retention_query when calling retentionAnalyzerExecute');
        }
